...
describe("removeNodeRecursive", () => {
  test("#1", () => {
    ...
    const result = removeNodeRecursive(root, 10);
  ...
  test("#2 remove root of tree", () => {
    ...
    const result = removeNodeRecursive(root, 5);
  ...
  test("#3", () => {
    ...
    const result = removeNodeRecursive(root, 41);
  ...
  test("#4", () => {
    ...
    const result = removeNodeRecursive(root, 4);
  ...
  test("#5", () => {
    ...
    const result = removeNodeRecursive(root, 6);
